...
let lastpera = document.getElementsByClassName("result")[0];
...
function selectModel() {
   ...
   con.appendChild(sbtn)
   let resultpera = document.createElement("P")
   resultpera.setAttribute('class','resultpera')
   resultpera.textContent = JSON.stringify(mobiles[brand.value][model.value])
   lastpera.appendChild(resultpera)
